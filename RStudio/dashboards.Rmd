...
### Total de vistas
```{r}
flexdashboard::valueBox(sum(df_videos$Vistas), icon = "fa-eye", color = 'red')
```

### Total de likes
```{r}
flexdashboard::valueBox(sum(df_videos$Likes), icon = "fa-thumbs-up", color = 'blue')
```

### Total de no me gusta
```{r}
flexdashboard::valueBox(sum(df_videos$`No me gusta`), icon = "fa-thumbs-down", color = 'green')
```

### Total de comentarios
```{r}
flexdashboard::valueBox(sum(df_videos$Comentarios), icon = "fa-comments", color = 'orange')
```
